description = [
    ...
    {
        'name': 'afghan_hound',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/f/fe/Afghan_Hound.jpg',
        'weight': '20–27 kg (Trưởng thành)',
        'height': '61–73 cm (Trưởng thành)',
        'description': 'Chó săn Afghan có ngoại hình nhìn chung ấn tượng, đầu chúng ngẩng cao, trông kiêu hãnh. Chúng thường biểu lộ vẻ trầm ngâm là một đặc trưng của loài chó này. Chúng tạo một ấn tượng mạnh về sức mạnh, sự dẻo dai và vẻ đường bệ, kết hợp với tốc độ và sức mạnh. Giống chó này quan sát mọi thứ rất nhanh, ít khi nán lại để nhìn lâu. Trong chúng khá đường bệ và di biệt, đồng thời có một vẻ sắc sảo, mạnh mẽ. Chiều cao của chó đực 68–74 cm (27-29 ins) còn chó cái là 63–69 cm (25-27 ins).',
        'origin': 'Afghanistan'
    },
    {
        'name': 'african_hunting_dog',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/The_Warrior_%2848031687366%29.jpg/600px-The_Warrior_%2848031687366%29.jpg',
        'weight': '22 kg (Trưởng thành)',
        'height': '92 cm (Trưởng thành)',
        'description': 'Chó hoang dã châu Phi là một động vật xã hội cao, sống trong các bầy có phân cấp thống trị riêng biệt cho con đực và con cái. Duy nhất trong số động vật ăn thịt xã hội, con cái chứ không phải là con đực sinh sống phân tán khỏi đàn khi thành thục về sinh dục, và con non được ưu tiên cho ăn đầu tiên khi bắt được con mồi. Loài này chuyên săn linh dương, bắt bằng cách đuổi theo chúng để làm con mồi mệt lữ và kiệt sức.',
        'origin': 'Châu Phi'
    },
    {
        'name': 'airedale',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/5/52/Airedale_Terrier.jpg',
        'weight': '40–50 pound (18–23 kg)',
        'height': '22–24 inch (56–61 cm)',
        'description': 'Giống như nhiều loài chó săn, giống chó này có lớp lông “gãy”, rất cứng và nhiều lông. Điều này có nghĩa là lông của loài này không quá dài để thành những đám rối, lông thẳng và gần nhau, bao bọc cơ thể và chân. Bộ lông ngoài cứng, nhiều lông, lớp lông phủ bên trong mềm hơn. Những bộ lông cứng nhất sẽ bị nhăn nheo hoặc hơi xoăn. Bộ lông mềm xoăn rất không được ưa thích.',
        'origin': 'Vương quốc Anh'
    },
    {
        'name': 'american_staffordshire_terrier',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/6/66/AMERICAN_STAFFORDSHIRE_TERRIER%2C_Zican%E2%80%99s_Bz_Ez_Dragon_%2824208348891%29.2.jpg',
        'weight': '25–32 kg',
        'height': '46–48 cm',
        'description': 'American Staffordshire Terrier là một giống chó trong nhóm chó pit bull được lai tạo với giống chó sục có nguồn gốc từ Hoa Kỳ. Là giống chó lông ngắn, có trọng lượng trung bình. Với thân hình nhìn rất lực lưỡng với nhiều cơ bắp phù hợp với tính cách chiến đấu.',
        'origin': 'Hoa Kỳ'
    },
    {
        'name': 'appenzeller',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Appenzeller001.jpg/600px-Appenzeller001.jpg',
        'weight': '22 – 32 kg (Trưởng thành)',
        'height': '52–56 cm (Trưởng thành)',
        'description': 'Chó Appenzeller là một giống chó chăn gia súc có nguồn gốc từ Thụy Sĩ. Đây là một trong 4 giống chó tam thể của Thụy Sĩ. Chúng thường được sử dụng làm chó canh gác, bảo vệ, kéo xe, chó trong nhà và các nông trại. Ngày nay, chúng được sử dụng làm chó nuôi trong gia đình và dùng để làm nhiều công việc khác nhau.',
        'origin': 'Thụy Sĩ'
    },
    {
        'name': 'australian_terrier',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Australian_Terrier2.jpg/600px-Australian_Terrier2.jpg',
        'weight': '6,4–7,3 kg',
        'height': '23–28 cm',
        'description': 'Chó sục Úc là một giống chó nhỏ, chân ngắn, cứng cáp. Chiều cao từ 23 đến 28 cm, nặng 4 đến 6 kg. Nó có đầu thủ dài, đôi tai dựng đứng, hình chữ V và cặp mắt đen lóe sáng. Mũi đen mà tạo thành hình chữ V giữa hai cánh mũi. Hai hàm răng nên khít như lưỡi kéo cắt. Cơ thể hơi dài hơn chiều cao, với lưng thẳng. Ngực khỏe khoắn, tương đối rộng và sâu.',
        'origin': 'Úc'
    },
    {
        'name': 'basenji',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Asia_figlia_di_Dulcinea_%26_Daiquiri.jpg/600px-Asia_figlia_di_Dulcinea_%26_Daiquiri.jpg',
        'weight': '20-25 pounds (9–11 kg.)',
        'height': '16-17 inches (41–43 cm.)',
        'description': 'Đây là giống chó săn có nguồn gốc từ lâu đời. Dấu hiệu đầu tiên của giống chó tương tự Basenji được tìm thấy ở những ngôi mộ ở Ai cập, và những bức vẽ trên tường từ 5000 năm trước. Còn được gọi là chó Congo, được mang đến châu Âu từ năm 1934. Những nhà nhân giống ở Anh đã chọn lọc và du nhập chúng ra toàn thế giới. Ở châu phi, Basenji được dùng để chỉ đường trong những khu rừng, để cảnh báo và đề phòng những con thú nguy hiểm tiến lại gần, và chúng còn được sử dụng để đi săn theo bầy đàn. Tộc dân Pig-mê (Azande và Mangbetu) gọi giống chó này là Vật nhỏ trong bụi và cho đến ngày nay chúng vẫn phục vụ cho việc săn bắn trên một vùng rộng lớn từ vùng trũng Kongo đến Sudan.',
        'origin': 'Cộng hòa Dân chủ Congo'
    },
    {
        'name': 'basset',
        'img': 'https://upload.wikimedia.org/wikipedia/commons/c/c7/Basset_hound_portrait.jpg',
        'weight': '55–75 pound (25–34 kg)',
        'height': '12–15 inch (30–38 cm)',
        'description': 'Chó săn Basset là giống chó săn với bản tính tự nhiên và hiền hòa, chó săn Basset xuất hiện lần đầu vào thế kỉ 16, với mục đích săn bắt những loài thú nhỏ như con lửng hay thỏ. Tính cách không hiếu chiến của chó săn Basset khiến chúng được yêu thích bởi những người sành nuôi chó, những thợ săn và trong cả các gia đình. Năm 1585 taị Pháp, lần đầu tiên các tên chó Basset (chó săn chân lùn) xuất hiện trong một cuốn sách nói về chuyện đi săn và được chú ý tại Anh quốc vào những năm cuối của thập kỷ 1800. Tại đảo quốc này chúng được nuôi để săn thỏ.',
        'origin': 'Anh, Pháp'
    },
    {
        'name': 'beagle',
